...
_ADVICE_BY_LEVEL_GROUP: dict[str, str] = {
    "E": (
        ...
        "Поэтому мой <b>совет #1</b> - не переставай учиться и сразу пробуй верную технику падела, как бы непривычно это ни было, зна"
        ...
        "<b>Совет #2</b> - меняй позицию на корте, в зависимости от структуры розыгрыша. Важно стараться как можно чаще стремиться и"
    ...
    "D": (
        ...
        "<b>Совет #1</b> <b>Сделай стекло своим напарником.</b>\n"
        ...
        "<b>Совет #2</b> <b>Пробуй разные удары</b> \n"

...
def build_default_flow() -> QuestionnaireFlow:
    ...
    q2 = Question(
        ...
        options=(
            AnswerOption("q2_months_lt_1", "меньше месяца", "q3"),
            AnswerOption("q2_months_1_2", "1–2 месяца", "q3"),
            AnswerOption("q2_months_2_4", "2–4 месяца", "q3"),
            AnswerOption("q2_months_4_6", "4–6 месяцев", "q3"),
            AnswerOption("q2_months_5_8", "5–8 месяцев", "q3"),
            AnswerOption("q2_months_7_11", "7–11 месяцев", "q3"),
            AnswerOption("q2_months_10_15", "10–15 месяцев", "q3"),
            AnswerOption("q2_months_18_24", "1.5–2 года", "q3"),
            AnswerOption("q2_months_24_plus", "2+ года", "q3"),
        ),
    )

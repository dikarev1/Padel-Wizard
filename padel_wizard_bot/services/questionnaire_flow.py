...
def build_default_flow() -> QuestionnaireFlow:
    q6 = Question(
        ...
        options=(
            ...
            AnswerOption("q6_opt3", "+ Volley, Lob", None),
            AnswerOption("q6_opt4", "+ Backhand Volley, half-Volley", None),
            AnswerOption("q6_opt5", "+ Bandeja, flat Smash/x4", None),
            AnswerOption("q6_opt6", "+ Bajada, Vibora", None),
            AnswerOption("q6_opt7", "+ Gancho/Rulo, Chiquita, Drop-shot", None),
            AnswerOption("q6_opt8", "+ Smash x3/Topspin", None),
    ...
    q1_1 = Question(
        ...
        options=(
            AnswerOption("q1_1_hours_10", "≈ 0-10 часов", "q2"),

...
def build_default_flow() -> QuestionnaireFlow:
    ...
    q5 = Question(
        id="q5",
        text="Вопрос 5️⃣ \ 6️⃣:\n\n"
        "Как бы ты описал свою игру <b>от стекла</b>?",
        options=(
    ...
    q2 = Question(
        ...
        text=(
        "Вопрос 2️⃣ \ 6️⃣:\n\n"
        "Переходим к опыту* игры <b>в Падел</b>.\n"
        "Как долго ты играешь в Падел?\n" 
        "(*Из расчета <i>1-2 раза в неделю</i>)"
        ),
        options=(
    ...
    q1_1 = Question(
        id="q1.1",
        text="Вопрос 1️⃣.2️⃣ \ 6️⃣:\n\n"
        "Какой сумарный опыт игры? (не считая Падел)\n\n"
        "Если играть <i>1-2 разав неделю</i>)"
        ,
        options=(
    ...
    q1 = Question(
        ...
        "⬇︎\n"
        "Вопрос 1️⃣.0️⃣ \ 6️⃣:\n\n"
        "Есть ли у тебя <b>опыт игры</b> в другие виды спорта, в которых как и в Паделе <b>используется ракетка и мяч?</b>\n"
        ),
        options=(

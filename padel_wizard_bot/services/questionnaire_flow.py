...
def build_default_flow() -> QuestionnaireFlow:
    q6 = Question(
        ...
        options=(
            ...
            AnswerOption("q6_opt3", "Вышеперечисленные удары + Volley, Lob                     ", None),
            AnswerOption("q6_opt4", "Вышеперечисленные удары + Backhand Volley, half-Volley    ", None),
            AnswerOption("q6_opt5", "Вышеперечисленные удары + Bandeja, flat Smash/x4          ", None),
            AnswerOption("q6_opt6", "Вышеперечисленные удары + Bajada, Vibora                  ", None),
            AnswerOption("q6_opt7", "Вышеперечисленные удары + Gancho/Rulo, Chiquita, Drop-shot", None),
            AnswerOption("q6_opt8", "Вышеперечисленные удары + Smash x3/Topspin                ", None),
